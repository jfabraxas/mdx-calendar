    ...
    editor.onDidChangeCursorPosition((e) => {
      ...
      if (mentionData) {
        ...
        if (editorDomNode) {
          ...
          const atCharacterCoords = editor.getScrolledVisiblePosition({
            lineNumber: triggerPosition.lineNumber,
            column: triggerPosition.column,
          });

          if (atCharacterCoords) {
            const editorRect = editorDomNode.getBoundingClientRect();
            const lineHeight = editor.getOption(monaco.editor.EditorOption.lineHeight);
            
            setDatePickerPosition({
              x: editorRect.left + atCharacterCoords.left - 8, // Slight offset to align with the '@' symbol
              y: editorRect.top + atCharacterCoords.top + lineHeight + 4, // Position below the line
            });
